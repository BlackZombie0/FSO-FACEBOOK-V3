...
while [ $count -le 100 ]
do
echo "Starting WE ARE FSOCIETY... [$count%]";
sleep 0.1
clear
(( count++ ))
done
...
echo '                  __________ ';
echo '           ______/ ________ \______ ';
echo '         _/      ____________      \_ ';
echo '       _/____________    ____________\_ ';
echo '      /  ___________ \  / ___________  \ ';
echo '     /  /XXXXXXXXXXX\ \/ /XXXXXXXXXXX\  \ ';
echo '    /  /############/    \############\  \ ';
echo '    |  \XXXXXXXXXXX/ _  _ \XXXXXXXXXXX/  | ';
echo '  __|\_____   ___   //  \\   ___   _____/|__ ';
echo '  [_       \     \  X    X  /     /       _] ';
echo '  __|     \ \                    / /     |__ ';
